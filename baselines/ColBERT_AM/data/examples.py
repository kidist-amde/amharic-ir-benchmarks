    ...
    def _load_file(self, path):
        ...
        with open(path) as f:
            for line in f:
                ...
                if isinstance(example, dict) and "doc_ids" in example:
                    example["doc_ids"] = example["doc_ids"][:nway]  # Slice 'doc_ids' field
                elif isinstance(example, list):
                    example = example[:nway]  # If example is a list, slice directly
                else:
